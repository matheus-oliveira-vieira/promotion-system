...
feature 'admin approves a promotion' do
  ...
  scenario 'must not be the promotion creator' do
    creator = User.create!(email: 'matheus@email.com', password: '123456')
    other_user = User.create!(email: 'oliveira@email.com', password: '123456')
    promotion = Promotion.create!(name: "Natal", description: "Promoção de Natal",
      code: "NATAL10", discount_rate: 10, coupon_quantity: 100,
  ...
  scenario 'successfully' do
    creator = User.create!(email: 'matheus@email.com', password: '123456')
    approval_user = User.create!(email: 'oliveira@email.com', password: '123456')
    promotion = Promotion.create!(name: "Natal", description: "Promoção de Natal",
      code: "NATAL10", discount_rate: 10, coupon_quantity: 100,
      expiration_date: "22/12/2033", user: creator)
